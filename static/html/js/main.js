...
var redirectUrl = document.querySelector('#redirectUrl').value.trim()
            ...
            login({
              callback: function (res) {
                if (String(res.statusCode) !== '200') {
                  location.replace('http://www.hqwx.com/login/?gotohere=' + encodeURIComponent(redirectUrl))
                } else {
