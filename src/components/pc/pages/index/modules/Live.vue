<template>
	<div class="live_container">
      ...
      <div class="live_card" v-for="(item, index) in data.class.slice(0, 3)" :key="index" :style="{borderColor: item.theme}">
        ...
        <div class="live_card_tag" :style="{borderBottomColor: item.tag.bgColor, borderRightColor: item.tag.bgColor}"></div>
