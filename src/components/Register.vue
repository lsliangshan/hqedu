    ...
    <div class="container" :style="containerStyles">
        ...
        <div class="form_container">
            ...
            <div class="form_row agreement">
                <Checkbox v-model="agreed"></Checkbox><span @click="toggleCheck">我已阅读并同意<</span><a href="javascript:">用户注册协议</a><span>></span>
            </div>
            <div class="form_row">
                <Button class="btn" :disabled="!agreed" :loading="isSubmitting" @click="submit">
                    <span>注册</span>
                </Button>
            </div>
            <div class="form_row">
